    ...
    <div className="impressum-wrapper">
      <div className="impressum-content">
        ...
        <p>
          ...
          finden Sie hier: <a href="http://developers.facebook.com/docs/plugins/" target="_blank" rel="noreferrer">developers.facebook.com</a>.
        </p>
        <p>
          ...
          <a href="http://de-de.facebook.com/policy.php" target="_blank" rel="noreferrer"> facebook.com/policy.php</a>.
        </p>
        <p>
        ...
        <p>
          Mithilfe der Google +1-Schaltfläche können Sie Informationen weltweit veröffentlichen. Google speichert sowohl
          die Information, dass Sie für einen Inhalt +1 gegeben haben, als auch Informationen über die Seite, die Sie beim
          Klicken auf +1 angesehen haben. Ihre +1 können als Hinweise zusammen mit Ihrem Profilnamen und Ihrem Foto in
          Google-Diensten eingeblendet werden.
        </p>
        <p>
          Google zeichnet Informationen über Ihre +1-Aktivitäten auf, um die Google-Dienste für Sie und andere zu verbessern.
          Um die Google +1-Schaltfläche verwenden zu können, benötigen Sie ein weltweit sichtbares, öffentliches Google-Profil,
        ...
        <p>
          ...
          Google-Datenschutzbestimmungen genutzt. Weitere Infos unter:
          <a href="https://www.google.com/policies/privacy/" target="_blank" rel="noreferrer"> google.com/policies/privacy</a>.
        </p>
